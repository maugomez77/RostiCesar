...
<table border="1"
	...
	<%
		    ...
		    lista = rostiAdmin.getListInfo("ReporteInventarioSalidaDiaParametrizado", request.getParameter("start") + "|" + request.getParameter("end"));
		    ...
		    for (int i = 0; i < lista.size(); i++) {
				...
				int cajasActuales = rostiAdmin.calculaCajasHistoricoSalida(box.getCodeProd(), box.getProv(), request.getParameter("start"), request.getParameter("end"));
