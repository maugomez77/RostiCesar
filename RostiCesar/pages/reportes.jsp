          	...
          	<div id="contentbox">
    			...
    			<jsp:include page="parteReportes/reportesParte.jsp"/>
    				...
    				<% if (request.getParameter("salida") == null) { %>   				
	    				<input type="submit" value="Vista Preeliminar" onclick=" return abrirVentana('<%= "&reporte=reportes" %>');">
	    			<% } else { %>
	    			    <input type="submit" value="Vista Preeliminar" onclick=" return abrirVentana('<%= "&reporte=reportes&salida=Y" %>');">
	    			<%} %>				
