...
<% if(request.getParameter("sessionid")!=null){
		...
		if(session.getId().equals(request.getParameter("sessionid"))){//person is logged in, so let him/her in.
            ...
            <%@ include file="../admin/Body.jsp" %>
          	...
          	<div id="contentbox">
    			<p><h2>Administraci&oacute;n de Reportes Unificado General</h2></p>
    			...
    			<jsp:include page="parteReportes/ESGeneralUnificado.jsp"/>
    				...
    				<br>			    				
	    			<input type="submit" value="Vista Preeliminar" onclick=" return abrirVentana('<%= "&reporte=ESGeneralUnificado" %>');">			
