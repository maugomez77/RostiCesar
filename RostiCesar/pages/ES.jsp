          	...
          	<div id="contentbox">
    			...
    			<jsp:include page="parteReportes/ESParte.jsp"/>
    				...
    				<% if (request.getParameter("salida") == null) { %> 
    					<input type="submit" value="Vista Preeliminar" onclick=" return abrirVentana('<%= "&reporte=ESParte" %>');">
    				<% } else { %>
    					<input type="submit" value="Vista Preeliminar" onclick=" return abrirVentana('<%= "&reporte=ESParte&salida=Y" %>');">
    				<% } %>				
