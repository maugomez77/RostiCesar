 ...
 * Testing.
 */
public final class TestingClientes {
    /**
     * Constructor privado.
     */
    private TestingClientes() {
    }
	...
	public static void main(final String[] args) {
    	...
    	ClientesDAOImpl est = (ClientesDAOImpl) 
            ObjectFactory.getObject("ClientesDAO");
        est.setLocal(true);
        ...
        while (iter.hasNext()) {
        	Clientes per = (Clientes) iter.next();
