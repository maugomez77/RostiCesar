...
import mx.com.rosti.servlets.InfoEtiquetasPDF;
...
public class EtiquetasCesar {
	...
	public String crearEtiquetas(final String ruta,
        ...
        try {
        	...
        	Utilerias.debug(this, "nombreRuta " + ruta + " " + archivo);
        	...
        	Utilerias.error(this, "Error: " + e.toString());
        } finally { 
        	document.close();
        }
