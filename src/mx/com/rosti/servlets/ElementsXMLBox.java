...
public class ElementsXMLBox {
    ...
    public ElementsXMLBox(String code, String desc,  int prov, String descProveedor,  String cantidad, int tipoProd, String tipoProdDesc, int unidadMedida, String unidadMedidaDesc, String storage) {
